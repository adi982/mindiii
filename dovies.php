                ...
                <div class="container">
                    <div class="d-main-heading">
                        <h2 class="DoviesTitle">
                            Welcome to
                            <span>Doviesfitness</span>
                        </h2>
                        <h3>A One Stop Fitness & Wellness Solution</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo  get_stylesheet_directory_uri() . '/assets/image/dovies-main-ban.75bcb9c9 (1).webp' ?>" alt="dovies-banner">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Doviesfitness -</span>
                            Dovies Trainers light up the individuals fitness
                        </h2>
                        <p>
                            Fitness web and applications have turned into a central piece of any fitness devotee's
                            day-to-day daily schedule. Following, wellness and exercise applications have turned out
                            to be extremely popular. Dovies come to tap a similar solid fixation. It's a
                            fitness-based site for clients and individuals.</p>
                        ...
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/PlanDetailsScreen.b7b86359.webp' ?>" alt="dovies-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/PlanScreen.669bd4aa.webp' ?>" alt="dovies-image2">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/screen29.406e37f8.webp' ?>" alt="dovies-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/screen2.54cceb17.webp' ?>" alt="dovies-image4">
                            </div>
                            <div class=" mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/screen8.36777cb2.webp' ?>" alt="dovies-image5">
                            </div>
                            <div class=" mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/screen25.8db38de3.webp' ?>" alt="dovies-image6">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container">
                    <div class="doviesPtn">
                        <h3>Trainers & Gyms Can Attract</h3>
                        <h2>MORE CUSTOMERS</h2>
                        <p>For fitness devotees "Dovies" resembles a help where they can find all the fitness hacks
                            in a single place. It is well-polished and rich with salient features that cover all the
                            choices you seek by becoming a member of a fitness app.</p>
                    </div>
                    <div class="portfolio-app-store">
                        <a href="">
                            <img src="<?php echo get_stylesheet_directory_uri() . '/' ?>assets/image/appstore1.4d62822e.webp" alt="appstore" class="mr-4">
                        </a>
                        <a href="">
