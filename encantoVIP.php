                ...
                <div class="container">
                    <div class="d-main-heading">
                        <h2 class="DoviesTitle">
                            Welcome to
                            <span>EncantoVIP</span>
                        </h2>
                        <h3>Best E-commerce platform in Spain</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/encantobn.6c47d980.webp' ?>" alt="encantovip-banner">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>EncantoVIP -</span>
                            Find all the most popular trend brands under the single umbrella with limited cost.
                        </h2>
                        <p>The Best Colombian Clothes in Spain! Butt Lift Jeans, Colombian Shapewear, Dresses,
                            Jewelry, Lingerie and all kinds of Accessories. The best of Colombia at the best price,
                            Leaders in Current Fashion.</p>
                        ...
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/encantoscreen1.fc360ae7.webp' ?>" alt="encantovip-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/encantoscreen2.c95e3f73.webp' ?>" alt="encantovip-image2">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/encanto2.e8ca981d.webp' ?>" alt="encantovip-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/encanto5.793477f8.webp' ?>" alt="encantovip-image4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/encanto4.ca236565.webp' ?>" alt="encantovip-image5">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/encanto1.6dba08d8.webp' ?>" alt="encantovip-image6">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container">
                    <div class="doviesPtn">
                        <p>Dress like you’re already famous express the fashion with us. Enhance your appearance,
                            found variety of fashionable products with discounted rates .Discover the new you our
                            fabric will build your trust in us. We promise the comfort of our clothes, Try Encanto
                            Never out of style.</p>
                    </div>
                    <div class="portfolio-app-store">
                        ...
                        <a href="">
                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/playstore1.a5ef44af.webp' ?>" alt="playstores">
                        </a>
                    </div>
                </div>
                <div class="p-Next">
