                ...
                <div class="container">
                    <div class="d-main-heading">
                        <h2 class="DoviesTitle">
                            Welcome to
                            <span>Breathconductor</span>
                        </h2>
                        <h3>Digital Therapeutics (DTx) Product</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/breathCbn.325e8100.webp' ?>" alt="breathconductor-banner">
                                </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Breathconductor -</span>
                            Self-guided digital breathing therapy solution Provider Through its Augmented Sound™
                            adaptive infrastructure (Muvik AI).
                        </h2>
                        <p>BreathConductor™ is a self-guided digital breathing therapy solution that supports
                            individual needs related to anxiety management and cognition, blending music and therapy
                            in a beautiful, personalized way. Powered by Augmented Sound™, BreathConductor™ is
                            supported by Muvik's internal Precision Respiration procedural entertainment media
                            production system that generates configurable, science-backed audio and visual breathing
                            interventions.</p>
                        <a href="https://mindiii.com" target="_blank" class="Dovies-button btn btn-primary">
                            <span>VISIT WEBSITE </span>
                        </a>
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/breathscreen1.b6f7c19c.webp' ?>" alt="breath-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/breathscreen2.c241dd56.webp' ?>" alt="breath-image2">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/breath4.8fea9b64.webp' ?>" alt="breath-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/breath1.b436e135.webp' ?>" alt="breath-image4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/breath2.fb8e7d5f.webp' ?>" alt="breath-image5">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/breath3.63255088.webp' ?>" alt="breath-image6">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>Breathconductor-
                            BreathConductor™ Digital Therapy Services, Personalized Wellness Programs for your
                            Unique Populations</h3>
                        <p> BreathConductor™ is a drug-free, safe and effective solution that relieves anxiety,
                            allows users to boost their performance effortlessly and achieve maximum benefits
                            through science-backed breathing AI in these areas. Changing patterns of breathing can
                            reduce stress, anxiety, depression, quiet agitation, enhance concentration, balance
                            emotions, reduce insomnia, relieve symptoms of Post Traumatic Stress Disorder (PTSD),
                            increase peak performance and improve personal relationships.</p>
                        <div class="bHeading">
                            <h6>Mindiii</h6>
                        </div>
                    </div>
                ...
                <div class="p-Next">
                    <h3>Next project</h3>
                    <p>Koobi</p>
                    <a href="#" class="shakeArrow"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
