            ...
            <div class="main_div1">
                <div class="container">
                    <div class="d-main-heading">
                        ...
                        <h3>Inspire people to discover happiness in the workplace</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/connectusbn1.9a097d8b.png' ?>" alt="connektus-banner">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>ConnektUs -</span>
                            Find and connect with quality candidates that meet your demands.
                        </h2>
                        <p>ConnektUs is an employment social media platform for the not-so-corporate. Our central
                            goal is to move individuals to find joy in the working environment. Our foundation is
                            intended to assist you with all your employment needs.</p>
                        <a href="https://www.connektus.com.au/" target="_blank" class="Dovies-button btn btn-primary">
                            <span>VISIT WEBSITE </span>
                        </a>
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/ConnektUs1.67d8d914.webp' ?>" alt="connektus-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/ConnektUs2.f685c91d.webp' ?>" alt="connektus-image2">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="portfolio-app-store">
                        ...
                        <a href="">
                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/playstore1.a5ef44af.web' ?>" alt="playstore">
                        </a>
                    </div>
                </div>
                <div class=" p-Next">
