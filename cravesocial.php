                ...
                <div class="container">
                    <div class="d-main-heading">
                        <h2 class="DoviesTitle">
                            Welcome to
                            <span>Crave Social</span>
                        </h2>
                        <h3>App to Connect Singles and Couples</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/craveBn.9b70547d.webp' ?>" alt="crave-social-banner">
                                </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Crave Social -</span>
                            A place where everyone has a voice to share, create, and connect with your matches.
                        </h2>
                        <p> Satisfy all your cravings bored of being single and looking for a potential date
                            something for everyone.'Craving' social contact is the same as craving food. Crave
                            Social is there to assist you with fulfilling those desires for human contact.Crave
                            assists you with finding nearby singles and couples ready to meet and have some good
                            times. Present hookups to find new companions in places you are travelling out to.</p>
                        ...
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/cravescreen1.a6ee7112.webp' ?>" alt="crave-social1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/cravescreen2.919d785c.webp' ?>" alt="crave-social2">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/crave4.ccfb9af0.webp' ?>" alt="crave-social3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/crave1.78790def.webp' ?>" alt="crave-social4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/crave2.bd9d3567.webp' ?>" alt="crave-social5">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/crave3.4a18b6d8.webp' ?>" alt="crave-social6">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>Finding individuals around that are searching for exactly the same things you are.</h3>
                        <p> Discover like-minded people nearby with the help of crave social post hookups to meet
                            new friends and start sharing images with your matches.Chat in private, your
                            informations are secure with us.We have attempted to fulfill everybody's desires in our
                            Application.Crave Social is FREE to download and use.</p>
                    </div>
