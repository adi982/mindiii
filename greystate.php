            ...
            <div class="main_div1">
                <div class="container">
                    <div class="d-main-heading">
                        ...
                        <h3>Bringing innovation and The IPM umbrella to your Facility</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/greystatebn2.329b4fc6.webp' ?>" alt="greystate-banner">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Greystate -</span>
                            Customized pest solutions designed specially for the food industry.
                        </h2>
                        <p>
                            Greystate Inc. is a specialty IPM provider located in the heart of Northern California,
                            focusing its attention specifically toward the food industry. Our goal is to provide our
                            customers with the highest quality IPM services while keeping the costs of our services
                            reasonable and fair.</p>
                        ...
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/GreyLogin.c4225cd6.webp' ?>" alt="greystate-image">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/GreySolutions1.a7e6e0cf.webp' ?>" alt="greystate-image2">
                                </div>
                            </div>
                        </div>
                    </div>
