                ...
                <div class="container">
                    <div class="d-main-heading">
                        <h2 class="DoviesTitle">
                            Welcome to
                            <span>Hobort Shipping</span>
                        </h2>
                        <h3>Transport and Logistics Company</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/hobortBn.ef92eb58.webp' ?>" alt="hobortshipping-banner">
                                </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Hobort Shipping -</span>
                            The perfect logistics solution your business ever needs.
                        </h2>
                        <p>Hobort Shipping - Feel A new amazing shipping experience With US Hobort Shipping services
                            was Founded in 2018 and is headquartered in Accra, Ghana With access to an integrated
                            global network of road, rail, and sea transport resources, the company prides itself on
                            delivering international service with local knowledge. We use a variety of e-business
                            solutions for efficient cargo bookings. Our customers are assured of safe and secure
                            handling of all goods.</p>
                        ...
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/hobortscreen1.0caee3ef.webp' ?>" alt="hobort-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/hobortscreen2.99f3f051.webp' ?>" alt="hobort-image2">
                                </div>
                            </div>
                        </div>
