            ...
            <nav class=" innerPageHeader navbar navbar-expand-md navbar-dark bg-dark fixed-top">
                <div class="container">
                    <div class="navbar-brand">
                        <a href=" http://68.178.171.183home/">
            ...
            <div class="main_div1">
                <div class="container">
                    <div class="d-main-heading">
                        ...
                        <h3>Spend less time organizing gatherings</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/hoopinBn.d223589b.webp' ?>" alt="hoopin-banner">
                                </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Hoopin -</span>
                            Hoopin enables anyone to make it easier to host or join gatherings
                        </h2>
                        <p>Life is a continuous event Hoopin makes it well in a synchronize manner it starts with an
                            invitation bring all your gatherings with family, friends,relatives, and communities
                            interest together. Created to remember each and every piece of events to cherish
                            forever.</p>
                        ...
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/hoopinscreen1.1e10992a.webp' ?>" alt="hoopin-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/hoopinscreen3.e64cc263.webp' ?>" alt="hoopin-image2">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/hoopin4.3737ef54.webp' ?>" alt="hoopin-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/hoopin1.75b77747.webp' ?>" alt="hoopin-image4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/hoopin2.67682955.webp' ?>" alt="hoopin-image5">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/hoopin3.c26f38c9.webp' ?>" alt="hoopin-image6" srcset="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>A single platform for engagement and organise eventst</h3>
                        <p>FUse posts to share information, thoughts,moments and much more.Use other highlights such
                            as use pools to capture the opinions and make better decisions. Helps in building social
                            networks as well, Download Hoopin FREE!.</p>
                    </div>
