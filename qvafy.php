                    ...
                    <div class="d-main-heading">
                        ...
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvafybn1.0297c1b7.webp' ?>" alt="qvafy-banner-image">
                                </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Qvafy -</span>
                            Provide the perfect solution for the food delivery
                        </h2>
                        <p>Find the best food and beverages to your doorstep from thousands of amazing restaurants.
                            Made with love, savored with interest.Can save a lot of time and effort. Qvafy supports
                            more than 3000 restaurants.</p>
                        <a href="https://www.qvafy.com/" target="_blank" class="Dovies-button btn btn-primary">
                            <span>VISIT WEBSITE </span>
                        </a>
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvafyscreen1.7fc47e1a.webp' ?>" alt="qvafy-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvafyscreen2.5110d58f.webp' ?>" alt="qvafy-image2">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvafyscreen6.2128d29b.webp' ?>" alt="qvafy-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvafyscreen5.55a81039.webp' ?>" alt="qvafy-image4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvafyscreen4.0119e177.webp' ?>" alt="qvafy-image5">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvafyscreen3.7778e149.webp' ?>" alt="qvafy-image6">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>Best On-Demand Delivery Platform</h3>
                        <p>
                            Users only need to place a delivery request on the website or its iOS or Android app,
                            and restaurant may rapidly dispatch the food while having Qvafy couriers take care of
                            delivery.</p>
                        <div class="bHeading">
                            <h6>Mindiii</h6>
                        </div>
