                        ...
                        <div aria-labelledby="dropdown-basic" class="moreMenuDrop dropdown-menu show dropdown-menu-right" style="margin: 0px;">
                            <div class="moreMenuDropItem">
                                <div id="menuList">
                                    ...
                                    <a href=" http://68.178.171.183contactus/" class="dropdown-item animate__animated  animate__zoomIn animate4s nav-link  headtab-link">
            ...
            <div class="main_div1">
                <div class="container">
                    <div class="d-main-heading">
                        ...
                        <h3>A Social Networking Application and Web for all immigration groups</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/chatimmibn.2687045b.webp ' ?>" alt="chatimmi-banner">
                                </div>
            ...
            <div class=" dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Chatimmi -</span>
                            Share, collaborate and connect with like minds and experts.
                        </h2>
                        <p>Chatimmi is an online platform that helps many aspiring immigrants, professionals, and
                            students across the globe who are faced with a common problem; inaccurate or untimely
                            information. Chatimmi provides a forum on which to communicate, collaborate, and share
                            experiences and resources - all in a fun and engaging way. It also connects community
                            members to consultants and subject matter experts for real-time advisory and other
                            relevant services.</p>
                        <a href="https://www.chatimmi.net/" target="_blank" class="Dovies-button btn btn-primary">
                            <span>VISIT WEBSITE </span>
                        </a>
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/chatimmi1.d114a96a.webp' ?>" alt="chatimmi-banner">
                                </div>
                            </div>
                            <div class=" mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/chatimmi2.73a58be3.webp' ?>" alt="chatimmi-image2">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/chatimmiscreen4.b1abd281.webp' ?>" alt="chatimmi-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/chatimmiscreen1.cface6d2.webp' ?>" alt="chatimmi-image4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/chatimmiscreen2.4b3ad332.webp' ?>" alt="chatimmi-image5">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/chatimmiscreen3.893c9976.webp' ?>" alt="chatimmi-image6">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>Make the right connections with Chatimmi Application</h3>
                        <p>The Chatimmi platform provides communities for diverse, multicultural networking based on
                            common interests, goals, and ideas. We enable them to explore all their study options in
                            one place and to find the best-fit study program that matches their needs, goals, and
                            preferences. Ask questions, chat with experts and fellow aspirants, express yourself,
