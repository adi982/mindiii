...
<head>
    ...
    <title>Web & Mobile App Development Company in India | IT Solution | Digital Transformation | MINDIII</title>
                ...
                <div class="container">
                    <div class="d-main-heading">
                        <h2 class="DoviesTitle">
                            Welcome to
                            <span>Reservision</span>
                        </h2>
                        <h3>Online Booking & Trip Management for Clients</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/Reservisionbn.871dbddb.webp' ?>" alt="Reservision-banner">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Reservision -</span>
                            All in one platform for Taxi management, Tour management, online trip booking.
                        </h2>
                        <p>The Reservision Platform allows to manage trips, accept new assignments, communicate with
                            dispatchers and passengers. It's a big travel and vehicle management platform.</p>
                        ...
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/Reservisionscreen1.70b90f5c.webp' ?>" alt="Reservision-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/Reservisionscreen2.fac63304.webp' ?>" alt="Reservision-image2">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/Reservision4.bb325507.webp' ?>" alt="Reservision-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/Reservision1.e17c05b4.webp' ?>" alt="Reservision-image4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/Reservision2.7ddf375b.webp' ?>" alt="Reservision-image5">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/Reservision3.cec39416.webp' ?>" alt="Reservision-image6">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container">
                    <div class="doviesPtn">
                        <h3>Provide B2B and B2C custom travel management services, Reservation management , Vehicle
                            maintanence services</h3>
                        <p> Offering your clients more command over their outing data, individual profiles and
                            checking past and impending excursions is turning into a need, instead of an
                            extravagance. Presently you can furnish them with an online interface that is
                            unquestionably easy to use, with practically zero set-up and preparing for your staff.
                        </p>
                    </div>
                    <div class="portfolio-app-store">

                        <a href="">
                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/playstore1.a5ef44af.webp' ?>" alt="">
                        </a>
                    </div>
                </div>
                <div class="p-Next">
                                                ...
                                                <div class="justify-content-center row">
                                                    <div class="col-lg-12 col-md-12">
                                                        <div class="contactForm">
                                                            ...
                                                            <h3 class="mb-4">Drop us a message for any query</h3>
                                                            <form action="" class="" id="mymodelform" method=" post">
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="formBasicEmail" class="form-label">Full
