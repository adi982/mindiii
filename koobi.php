            ...
            <div class="main_div1">
                <div class="container">
                    <div class="d-main-heading">
                        ...
                        <h3>Hair & Beauty service providers</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/koobiBn.4d96fe98.webp' ?>" alt="koobi-banner-image">
                                </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Koobi -</span>
                            Book the best Hair & Beauty service providers near you.
                        </h2>
                        <p>Koobi is a beautifully designed platform that enables you to Search, Discover, Compare
                            and Book the best Hair & Beauty service providers near you. All done simply,
                            effortlessly and efficiently at your fingertips.</p>
                        ...
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/koobiscreen2.382d1d07.webp' ?>" alt="koobi-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/koobiscreen1.b4f0e80a.webp' ?>" alt="koobi-image2">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/koobiBn.4d96fe98.webp' ?>" alt="koobi-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/koobi1.6c0bdfa9.webp' ?>" alt="koobi-image4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/koobi2.14aabff0.webp' ?>" alt="koobi-image6">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/koobi3.1fe512fa.webp' ?>" alt="koobi-image6">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>revolutionary new application for aspiring or existing Hair & Beauty specialists</h3>
                        <p> Thanks to Koobi your Hair & Beauty possibilities are now endless! Koobi makes it
                            possible get your Hair & Beauty services done at your place of comfort, Whether that's
                            at your home, down the street or even at your office! Koobi has an array of features to
                            serve your convenience.</p>
                        <div class="bHeading">
                            <h6>Mindiii</h6>
                        </div>
                    </div>
