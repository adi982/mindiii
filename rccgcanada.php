                ...
                <div class="container">
                    <div class="d-main-heading">
                        <h2 class="DoviesTitle">
                            Welcome to
                            <span>Rccgcanada</span>
                        </h2>
                        <h3>Church Managment Software</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/RccgcanadaBn.6d6033f7.webp' ?>" alt="Rccgcanada-banner-image">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Rccgcanada -</span>
                            Easy-to-use church management software to quickly organize people, groups, events,
                            contributions.
                        </h2>
                        <p>
                            Church management software automates various functions for churches. Churches use church
                            management tools to track resources and manage admin functions, as well as for
                            accounting, membership management, donation tracking, and event schedule.
                        </p>
                        ...
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/Rccgcanada1.27843f73.webp' ?>" alt="Rccgcanada-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/Rccgcanada2.efd06770.webp' ?>" alt="Rccgcanada-image2">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>The Redeemed Christian Church of God</h3>
                        <p>
                            (RCCG) has a vision to spread the Word of God to the ends of the earth.The General
                            Overseer of the church is Pastor E.A. Adeboye.The church was founded in 1952 and since
                            then, the church has grown to over 23,000 parishes worldwide (July 2011).Presently,
                            there are established missions in many African countries, as well as Europe, Asia, the
                            United States, the Caribbean, Canada, South America and Australia.</p>
                        <div class="bHeading">
                            <h6>Mindiii</h6>
                            </p>
                        </div>
