            ...
            <div class="main_div1">
                <div class="container">
                    <div class="d-main-heading">
                        ...
                        <h3>A Online Parking spots Solution Provider Application & Web</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/parkswapbn1.95c05405.webp' ?>" alt="parkswap-banner">
                                </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>ParkSwap -</span>
                            On street parking spots for the world
                        </h2>
                        <p>ParkSwap helps millions of people easily find on-street parking spots on their mobile
                            phones No stress, No hassle. Additionally, ParkSwap offers ''Send and Receive Gift'' for
                            parking spots. We’re giving people around the world a smarter way to park their cars.
                        </p>
                        <a href="https://www.doviesfitness.com/" target="_blank" class="Dovies-button btn btn-primary">
                            <span>VISIT WEBSITE </span>
                        </a>
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/parkswap23.da370484 (1).webp' ?>" alt="parkswap-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/parkswap22.8fb77523.webp' ?>" alt="parkswap-image2">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/parkswap1.64de4bb7.webp' ?>" alt="parkswap-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/parkswap2.f3a9dc08.webp' ?>" alt="parkswap-image4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/parkswap3.6a857a79.webp' ?>" alt="parkswap-image5">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/parkswap4.192ac9ad.webp' ?>" alt="parkswap-image6">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>Completely transform the parking experience</h3>
                        <!-- <h2>MORE CUSTOMERS</h2> -->
                        <p>ParkSwap is a community based app that allows drivers to provide their spots to
                            otherdrivers instantly. We completely transform the parking experience. ParkSwap offers
                            a smarter and faster way to park. Not only we help subscribers assist other subscribers
                            to find On-street parking spots easier, but we also give them a chance of receiving a
                            Gift for providing information about their spots when they swap it.</p>
                    </div>
                    <div class="portfolio-app-store">
                        <a href="">
                            <img class="mr-2" src="<?php echo get_stylesheet_directory_uri() . '/assets/image/appstore1.4d62822e.webp' ?>" alt="appstore">
                        </a>
                        <a href="">
