                    ...
                    <div class="d-main-heading">
                        ...
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvazonbn.56f08e0d.webp' ?>" alt="qvazon-banner-image">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        ...
                        <p>You can Shop Online for Men & Women Clothing, Shoes, Kid's fashion, Home Decor & Kitchen
                            Appliances & Much More! Best Sellers a wide range of fashion & lifestyle products from
                            top brands at the best prices.</p>
                        ...
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvazonscreen25.590bca2a.webp' ?>" alt="qvazon-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvazonscreen26.4c15893c.webp' ?>" alt="qvazon-image2">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvazon15.7eb1ccbc.webp' ?>" alt="qvazon-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvazon12.1b75dd0c.webp' ?>" alt="qvazon-image4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvazonNext.bcfd26b4.we' ?>bp" alt="qvazon-image5">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvazon11.8c2cb554.webp' ?>" alt="qvazon-image6">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>Buy anything free shipping worldwide</h3>
                        <p> Upgrade yourself with Qvazon Top rated, premium quality brands and more, Therefore shop
                            by category.</p>
                        <div class="bHeading">
                            <h6>Mindiii</h6>
                        </div>
