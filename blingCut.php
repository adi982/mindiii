        ...
        <div class="main_div1">
            <div class="container">
                <div class="d-main-heading">
                    ...
                    <h3>Online Hair and Beauty services booking platform</h3>
                    <div class="row">
                        <div class="col-lg-6 mx-auto">
                            <div class="doviesCnt">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/blingcutBn.9303da5a.webp' ?>" alt="blingcut-banner">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="dbanner-area">
            <div class="container">
                <div class="doviesFnt">
                    ...
                    <p>BlingCut is a beautifully designed software that enables you to Search, Discover, Compare
                        and Book the best Hair & Beauty service providers near you and book appointments for the
                        services. All done simply, effortlessly and efficiently at your fingertips.</p>
                    ...
                    <div class="my-5 doviesWt row">
                        <div class="mb-5 dWtPct col-lg-6">
                            <div class="dCnt_img ">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/blingcutscreen1.b494124c.webp' ?>" alt="blingcut-image1">
                            </div>
                        </div>
                        <div class="mb-5 dWtPct col-lg-6">
                            <div class="dCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/blingcutscreen2.604ef1bd.webp' ?>" alt="blingcut-image2">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="doviesTest">
                        <div class="mt-20 SCnt_img">
                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/blingcut4.4058f33f.webp' ?>" alt="blingcut-image3">
                        </div>
                        <div class="mt-21 SCnt_img">
                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/blingcut1.5cdd819e.webp' ?>" alt="blingcut-image4">
                        </div>
                        <div class="mt-20 SCnt_img">
                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/blingcut2.cbb0d2e2.webp' ?>" alt="blingcut-image5">
                        </div>
                        <div class="mt-21 SCnt_img">
                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/blingcut3.7f41fb11.webp' ?>" alt="blingcut-image6">
                        </div>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="doviesPtn">
                    <h3>BlingCut Online Barber Marketplace for Booking Appointments</h3>
                    <p> BlingCut System is a complete and easy to manage appointments scheduling system to help
                        your business getting more reservations on your Shop and saving a lot of time with your
                        agenda management tasks. It has developed for both Service providers and customers.</p>
                    <div class="bHeading">
                        <h6>Mindiii</h6>
                    </div>
                </div>
