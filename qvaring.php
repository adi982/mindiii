            ...
            <div class="main_div1">
                <div class="container">
                    <div class="d-main-heading">
                        ...
                        <h3>Safest and Easiest Recharges</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvaringbn2.c6267102.webp' ?>" alt="qvaring-banner-image">
                                </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Qvaring -</span>
                            Your communication needs are safest and reliable with us.
                        </h2>
                        <p>Meet Qvaring we are a group of youthful Cuban business people, The Mobile recharge brings
                            you closer to family and friends while Saving you Money. Yours Recharges are always easy
                            and 100% Safe. Recharges of all operators, with no commissions.</p>
                        <a href="https://qvaring.qvastag.com/" target="_blank" class="Dovies-button btn btn-primary">
                            <span>VISIT WEBSITE </span>
                        </a>
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvaring22.09af0b14.webp' ?>" alt="qvaring-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvaring23.e55298b3.webp' ?>" alt="qvaring-image2">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvaringscreen4.ef4c772c.webp' ?>" alt="qvaring-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvaringscreen1.51a61879.webp' ?>" alt="qvaring-image4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvaringscreen2.304b52ff.webp' ?>" alt="qvaring-image5">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/qvaringscreen3.1d16bd5c.webp' ?>" alt="qvaring-image6">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>More united and connected with our people in Cuba</h3>
                        <p> Committed to our worldwide local area on the island. Qvaring wants to facilitate your
                            people greater access to Data and therefore more sources of information for your family
                            and friends. Join the Qvaring family and start Saving Money Now!.</p>
                    </div>
