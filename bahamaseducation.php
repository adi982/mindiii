...
/**
 * Template Name:bahamaseducation
 * 
 * 
 */
// get_header();
                        ...
                        <div aria-labelledby="dropdown-basic" class="moreMenuDrop dropdown-menu show dropdown-menu-right" style="margin: 0px;">
                            <div class="moreMenuDropItem">
                                <div id="menuList">
                                    ...
                                    <a href=" http://localhost/mindiii_website_wordpres/contactus/" class="dropdown-item animate__animated  animate__zoomIn animate4s nav-link  headtab-link  headtab-link  headtab-link">
                ...
                <div class="container">
                    <div class="d-main-heading">
                        <h2 class="DoviesTitle">
                            Welcome to
                            <span> Bahamas EducationMix</span>
                        </h2>
                        <h3>Online platform learn by self-testing</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/bahamasbn.5419d642.webp' ?>" alt="bahamas-banner">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Bahamas EducationMix -</span>
                            Children eLearning platform working with the concept of stress free learning.
                        </h2>
                        <p>
                            An online platform that allows students to learn by self-testing through the four core
                            subjects (English Language, Mathematics, Science & Social Studies). Each subject is
                            based on The Bahamas Curriculum and seeks to achieve higher test scores on both
                            school-based and national exams as a student matriculates from primary to junior high
                            school.
                        </p>
                        <a href="https://rccgcanada.org/" target="_blank" class="Dovies-button btn btn-primary">
                            <span>VISIT WEBSITE </span>
                        </a>
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/bahamas2.4fe9ccdc.webp' ?>" alt="bahamas-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/bahamas3.4ac67fdf.webp' ?>" alt="bahamas-image2">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>An interactive, digital environment where test-taking is fun and beneficial</h3>
                        <p>
                            Take part in timed tests or quizzes that apply what you've learnt in class. a platform
                            for online learning with a comprehensive range of services to improve education.
                            Discover the best way to choose a platform for your Childern training. E-learning tools'
                            main function is to author, or generate, educational resources.</p>
                        <div class="bHeading">
                            <h6>Mindiii</h6>
                            </p>
                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <span class="text-muted form-text" style="color: #6C757D ;">We'll never share
                                                                    your
