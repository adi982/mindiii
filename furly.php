            ...
            <div class="main_div1">
                <div class="container">
                    <div class="d-main-heading">
                        ...
                        <h3>Best Cat Care App</h3>
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="doviesCnt">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/furlyBn1.ff2fc727.webp' ?>" alt="furly-banner">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="dbanner-area">
                <div class="container">
                    <div class="doviesFnt">
                        <h2>
                            <span>Furly -</span>
                            Time spend with cats is never wasted cat is the ideal pet
                        </h2>
                        <p>Furly replicates the joy of loving your pet through the calming act of petting We can
                            fill your empty house. People who love cats have some of the biggest heart in the
                            world.We love our animals and we know you will too!.</p>
                        ...
                        <div class="my-5 doviesWt row">
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img ">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/furlyscreen.34f789ae.webp' ?>" alt="furly-image1">
                                </div>
                            </div>
                            <div class="mb-5 dWtPct col-lg-6">
                                <div class="dCnt_img">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/furlyscreen33.2e6a79b4.webp' ?>" alt="furly-image2">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="doviesTest">
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/furly4.e34210a9.webp' ?>" alt="furly-image3">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/furly5.af4f73d1.webp' ?>" alt="furly-image4">
                            </div>
                            <div class="mt-20 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/furly2.e1e7dd4c.webp' ?>" alt="furly-image5">
                            </div>
                            <div class="mt-21 SCnt_img">
                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/image/furly3.9026900d.webp' ?>" alt="furly-image6">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="doviesPtn">
                        <h3>Life is better with cats,Cat Care and Cat health in single App</h3>
                        <p>
                            Every pet is family, member 1 pet store in the town get all your comfy with furly.Cat
                            care and cat health application get complete pet care solutions with furly.</p>
                    </div>
